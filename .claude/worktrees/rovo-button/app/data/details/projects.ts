...
export const PROJECT_DETAILS: Record<string, ComponentDetail> = {
	...
	"rovo-button": {
		description: "A floating Rovo button that opens a compact chat panel with quick actions, context chip, and composer — modeled on the kg-prototyping floating Rovo experience.",
		importStatement: `import RovoButton from "@/components/projects/rovo-button/page";`,
		demoLayout: {
			previewHeight: "fixed",
		},
	},
