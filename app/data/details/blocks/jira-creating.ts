...
export const JIRA_CREATE_DETAIL: ComponentDetail = {
	description:
		"Kanban demo of a work item being created: the whole card enters as one object (fade + scale) while the column grows and pushes neighbors. Add 1 or Add 2, choose Top / Middle / Bottom, and Restart to reset the board.",
	demoLayout: { previewHeight: "fit", examplesContentWidth: "bleed" },
	importStatement: `import { JiraCreateBoard, JiraCreateCard } from "@/components/blocks/jira-creating";`,
	usage: `import JiraCreatePage from "@/components/blocks/jira-creating/page";
	...
	examples: [
		{
			...
			demoSlug: "jira-creating-demo-work-item",
		},
		{
			...
			demoSlug: "jira-creating-demo-sessions",
		},
	],
	props: [
