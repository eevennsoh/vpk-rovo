...
<CreateInput onSubmit={({ text, files }) => sendMessage({ text, files })}>
  <CreateInputBody>
    <CreateInputTextarea placeholder="Ask anything..." rows={1} />
  </CreateInputBody>
  <CreateInputFooter className="justify-between px-1">
    <CreateInputTools>
      <CreateInputActionMenu>
        <CreateInputActionMenuTrigger aria-label="Add">
          <AddIcon label="" />
        </CreateInputActionMenuTrigger>
        <CreateInputActionMenuContent>
          <CreateInputActionMenuItem>Add context</CreateInputActionMenuItem>
        </CreateInputActionMenuContent>
      </CreateInputActionMenu>
    </CreateInputTools>
    <CreateInputSubmit />
		...
		subComponents: [
			{ name: "CreateInputProvider", description: "Optional provider for externally controlled text input and attachments." },
			{ name: "CreateInputBody", description: "Body slot that wraps the main textarea input region." },
			{ name: "CreateInputTextarea", description: "Autosizing textarea with Enter-to-submit and paste-file support." },
			{ name: "CreateInputHeader", description: "Top aligned addon row for tabs, modes, or context chips." },
			{ name: "CreateInputFooter", description: "Bottom aligned addon row for tools and submit actions." },
			{ name: "CreateInputTools", description: "Inline tools container commonly used inside CreateInputFooter." },
			{ name: "CreateInputButton", description: "Action button primitive with optional tooltip support." },
			{ name: "CreateInputActionMenu", description: "Dropdown menu container for add/context actions." },
			{ name: "CreateInputActionMenuTrigger", description: "Menu trigger button specialized for CreateInput actions." },
			{ name: "CreateInputActionMenuContent", description: "Menu content panel aligned for prompt actions." },
			{ name: "CreateInputActionMenuItem", description: "Individual menu item for quick prompt actions." },
			{ name: "CreateInputActionAddAttachments", description: "Prebuilt menu item that opens the file picker." },
			{ name: "CreateInputSelect", description: "Select wrapper for model/reasoning/verbosity controls." },
			{ name: "CreateInputSubmit", description: "Submit/stop button with chat status-aware icon states." },
		],
		examples: [
