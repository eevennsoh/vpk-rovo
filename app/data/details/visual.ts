...
<ScrambleText duration={1} delay={stagger(0.05, { from: "center" })}>
	...
	"graph": {
		...
		props: [
			...
			{ name: "initialParams", type: "Partial<NeuralGraphParams>", default: "ROVO_GRAPH_DEFAULT_PARAMS", description: "Initial values for speed, amplitude, frequency, octaves, structure, cone, and node style controls." },
...
/>`,
		props: [
			...
			{ name: "chromatic", type: "boolean | number", default: "false", description: "Adds subtle radial chromatic channel sampling." },
			...
			{ name: "characterChromatic", type: "boolean | number", default: "false", description: "Adds per-glyph red/blue fringe coloration." },
			...
			{ name: "rgbSplit", type: "boolean | number", default: "false", description: "Adds stronger radial RGB channel splitting. `chromaticAberration` remains as a backwards-compatible alias." },
			{ name: "blur", type: "boolean | number", default: "false", description: "Mixes in a single-pass blurred source approximation." },
			{ name: "pixelate", type: "boolean | number", default: "false", description: "Mixes in a block-sampled source approximation." },
			{ name: "halftone", type: "boolean | number", default: "false", description: "Adds a rotated halftone dot mask over the final color." },
			{ name: "filmDust", type: "boolean | number", default: "false", description: "Adds sparse temporal dust specks in the final post-process pass." },
