...
<ScrambleText duration={1} delay={stagger(0.05, { from: "center" })}>
	...
	"graph": {
		...
		props: [
			...
			{ name: "initialParams", type: "Partial<NeuralGraphParams>", default: "ROVO_GRAPH_DEFAULT_PARAMS", description: "Initial values for flow, structure, cone, token-backed node and edge color states, ray, origin node, hover, label, and node style controls." },
