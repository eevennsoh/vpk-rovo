...
} = require("./future-chat-generated-files");
...
test("generated files manager backfills manifest entries and relocates untracked root files", async () => {
	const baseDir = await createTempDir("future-chat-generated-base-");
	const projectRoot = await createTempDir("future-chat-generated-project-");
	const manager = createFutureChatGeneratedFilesManager({
		baseDir,
		projectRoot,
		logger: console,
	});
...
test("generated files manager can snapshot root files into the thread workspace without removing them", async () => {
	const baseDir = await createTempDir("future-chat-generated-copy-base-");
	const projectRoot = await createTempDir("future-chat-generated-copy-project-");
	const manager = createFutureChatGeneratedFilesManager({
		baseDir,
		projectRoot,
		logger: console,
...
test("generated files manager seeds legacy confirmed paths into the manifest", async () => {
	const baseDir = await createTempDir("future-chat-generated-seed-");
	const projectRoot = await createTempDir("future-chat-generated-project-");
	const manager = createFutureChatGeneratedFilesManager({
		baseDir,
		projectRoot,
