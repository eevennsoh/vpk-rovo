...
/**
 * Retry an operation while Rovo reports "chat already in progress" (409).
...
/**
 * Enqueue non-streaming text generation calls so only one Rovo request runs
 ...
 * @returns {Promise<T>}
 */
function enqueueTextGeneration(operation, { logPrefix = "generateTextViaRovo" } = {}) {
