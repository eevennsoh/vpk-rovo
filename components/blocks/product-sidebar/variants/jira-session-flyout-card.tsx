 ...
 * optional trailing lozenge, optional top-bordered body, artifact Smart Links,
...
export function JiraSessionFlyoutCard({
	...
	return (
		<section
			...
			className={cn(
				"flex w-[320px] max-w-[calc(100vw-48px)] flex-col gap-3 pt-3 text-text",
				hasBodyRegion || footer ? undefined : "pb-3",
			)}
		>
