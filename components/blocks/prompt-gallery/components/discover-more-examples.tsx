...
import { getExamplePrompt, PROMPT_GALLERY_ROLE_OPTIONS, PROMPT_GALLERY_USE_CASE_OPTIONS, type PromptGalleryExample } from "../data/examples";
		...
		<div className="flex w-full flex-col">
			...
			<div className="flex items-center justify-between">
				<div className="flex gap-2">
					<CheckboxFilterDropdown label="Use cases" options={PROMPT_GALLERY_USE_CASE_OPTIONS} selectedValues={selectedUseCases} onToggle={toggleUseCase} />
					<CheckboxFilterDropdown label="Roles" options={PROMPT_GALLERY_ROLE_OPTIONS} selectedValues={selectedRoles} onToggle={toggleRole} />
				</div>
