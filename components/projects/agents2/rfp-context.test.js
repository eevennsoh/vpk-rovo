...
const DETAILS_ACCORDION_SOURCE = fs.readFileSync(
	path.join(process.cwd(), "components/projects/agents2/components/work-item-modal/details-accordion.tsx"),
	"utf8",
);
const ATTACHMENTS_SECTION_SOURCE = fs.readFileSync(
	path.join(process.cwd(), "components/projects/agents2/components/work-item-modal/attachments-section.tsx"),
	"utf8",
);
