...
import { getJiraGoldenJourneysV5PullRequestPreview } from "./presentation-pull-requests";
...
export const JIRA_GOLDEN_JOURNEYS_V5_PAY_SESSION_MEMBER_ID_BY_ASSIGNEE_ID = {
	"diego-santos": "diego",
...
export const JIRA_GOLDEN_JOURNEYS_V5_PAY_BOARD_AGENTS = [
	{
		id: "claude-code",
		name: "Claude Code",
...
export function toJiraGoldenJourneysV5AgentActivityFromSession(
...
export function toJiraGoldenJourneysV5DetachedAgentSession(
...
export const JIRA_GOLDEN_JOURNEYS_V5_PAY_COMPOSER_AGENTS = [
	{
		id: "claude-code",
		name: "Claude Code",
		byline: "Coding agent by Anthropic",
...
export const JIRA_GOLDEN_JOURNEYS_V5_PAY_HEADER_ASSIGNEES = [
	{
		id: "venn",
		name: "Venn",
...
function attachPullRequestPreview(
	...
	const preview = getJiraGoldenJourneysV5PullRequestPreview(code);
	if (!preview) {
...
export const JIRA_GOLDEN_JOURNEYS_V5_PAY_STATUS_PHASES = [
	"To do",
	"In progress",
	"In review",
	"Done",
	...
	},
	{
		...
		cards: [
			createCard({
				...
				code: "PAY-101",
				priority: "major",
				pullRequestNumber: JIRA_GOLDEN_JOURNEYS_V5_PAY_101_PULL_REQUEST_NUMBER,
...
export function createJiraGoldenJourneysV5PayBoardColumns(): JiraKanbanColumnData[] {
