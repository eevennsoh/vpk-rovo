...
export const JIRA_GOLDEN_JOURNEYS_V5_PULL_REQUEST_PREVIEWS = {
...
export function getJiraGoldenJourneysV5PullRequestPreview(
	code: string,
): JiraIssuePullRequestPreview | undefined {
	return JIRA_GOLDEN_JOURNEYS_V5_PULL_REQUEST_PREVIEWS[
		code as keyof typeof JIRA_GOLDEN_JOURNEYS_V5_PULL_REQUEST_PREVIEWS
	];
}
