 ...
 *
 * Split out of `jira-golden-journeys-v5.test.js` so that suite stays under the
...
test("the route pins the shared Agent Session column beside Jira statuses", () => {
	...
	assert.match(PAGE_SOURCE, /agentSessionAssigneeIdAliases=\{JIRA_GOLDEN_JOURNEYS_V5_PAY_SESSION_MEMBER_ID_BY_ASSIGNEE_ID\}/u);
