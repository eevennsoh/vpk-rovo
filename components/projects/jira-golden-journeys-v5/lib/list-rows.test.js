...
const {
	...
	insertWorkItemCard,
	moveListOrder,
	progressJiraGoldenJourneysV5WorkItemOnStart,
...
test("starting an agent session progresses only To do and Done work items", () => {
	...
	const fromTodo = progressJiraGoldenJourneysV5WorkItemOnStart(
	...
	const fromDone = progressJiraGoldenJourneysV5WorkItemOnStart(
	...
	const fromReview = progressJiraGoldenJourneysV5WorkItemOnStart(
