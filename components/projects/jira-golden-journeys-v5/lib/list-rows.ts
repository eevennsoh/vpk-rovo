...
export const JIRA_GOLDEN_JOURNEYS_V5_LIST_STATUS_OPTIONS: readonly JiraListStatusOption[] = [
...
export function progressJiraGoldenJourneysV5WorkItemOnStart(
...
export function applyAssignedAgentIdsToColumns(
	...
	return started
		? progressJiraGoldenJourneysV5WorkItemOnStart(nextColumns, issueKey)
		: nextColumns;
}
