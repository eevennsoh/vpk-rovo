...
export interface JiraGoldenJourneysV5TerminalStoryProps {
...
export function JiraGoldenJourneysV5TerminalStory({
	controller,
	promptCopied = false,
	resetKey,
	theme = "dark",
}: Readonly<JiraGoldenJourneysV5TerminalStoryProps>): React.ReactElement {
