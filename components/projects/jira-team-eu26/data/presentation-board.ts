...
export function toJiraTeamEu26DetachedAgentSession(
...
function attachPullRequestPreview(
	...
	const preview = getJiraTeamEu26PullRequestPreview(code);
	if (!preview) {
...
export const JIRA_TEAM_EU26_PAY_STATUS_PHASES = [
	"To do",
	"In progress",
	"In review",
	"Done",
...
export function createJiraTeamEu26PayBoardColumns(): JiraKanbanColumnData[] {
