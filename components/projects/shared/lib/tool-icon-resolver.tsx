...
const NATIVE_TOOL_ICONS = new Map<string, (props: NewCoreIconProps) => ReactNode>([
	...
	[normalizeToken("omni.map_page_story")!, ListChecklistIcon],
	[normalizeToken("omni.check_content_gaps")!, TaskToDoIcon],
	...
	[normalizeToken("vpk_html.render_one_pager")!, TemplateIcon],
	[normalizeToken("vpk_html.validate_artifact")!, CheckCircleIcon],
	[normalizeToken("generate_html.distill_fields")!, ListChecklistIcon],
	[normalizeToken("generate_html.render_one_pager")!, TemplateIcon],
	[normalizeToken("generate_html.validate_artifact")!, CheckCircleIcon],
