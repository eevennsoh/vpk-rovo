...
import type { RovoAppComposerResponseGradientPhase } from "@/components/projects/studio/lib/rovo-app-composer-response-gradient-state";
import {
...
type RovoAppComposerResponseGradientProps = {
	active?: boolean;
	className?: string;
	phase?: RovoAppComposerResponseGradientPhase;
...
export function RovoAppComposerResponseGradient({
	active = false,
	className,
	phase = "warmup",
	signal = [],
}: Readonly<RovoAppComposerResponseGradientProps>) {
	...
	return (
		<div
			...
			data-slot="rovo-app-response-gradient"
			ref={containerRef}
		>
			<canvas
				aria-hidden="true"
