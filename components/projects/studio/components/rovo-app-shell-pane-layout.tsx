...
export function RovoAppShellPaneLayout({
	...
	// Agent config pane takes priority over artifact/browser previews. The
	// Ask Rovo sidebar chat (mounted by RovoAppShell) handles all custom-agent
	// interaction, so the config pane renders full-width with no embedded chat.
