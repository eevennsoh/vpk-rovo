...
export function SnippetAddon(props: Readonly<SnippetAddonProps>) {
	return <InputGroupAddon {...props} />;
}

export type SnippetTextProps = ComponentProps<typeof InputGroupText>;

export function SnippetText({ className, ...props }: Readonly<SnippetTextProps>) {
	return (
		<InputGroupText
...
export function SnippetInput({ className, ...props }: Readonly<SnippetInputProps>) {
...
export function SnippetCopyButton({
	...
	className,
	...props
}: Readonly<SnippetCopyButtonProps>) {
