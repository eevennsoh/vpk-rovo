...
export function TerminalCopyButton({
	...
	className,
	...props
}: Readonly<TerminalCopyButtonProps>) {
...
export function TerminalClearButton({
	...
	className,
	...props
}: Readonly<TerminalClearButtonProps>) {
