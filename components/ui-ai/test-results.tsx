...
export function TestResultsHeader({
	...
	children,
	...props
}: Readonly<TestResultsHeaderProps>) {
	return (
		<div
			className={cn(
...
export function TestResultsSummary({
	...
	children,
	...props
}: Readonly<TestResultsSummaryProps>) {
...
export function TestResultsDuration({
	...
	children,
	...props
}: Readonly<TestResultsDurationProps>) {
	const { summary } = use(TestResultsContext);
...
export function TestResultsProgress({
	...
	children,
	...props
}: Readonly<TestResultsProgressProps>) {
	const { summary } = use(TestResultsContext);
...
export function TestResultsContent({
	...
	children,
	...props
}: Readonly<TestResultsContentProps>) {
	return (
...
export function TestSuiteContent({
	...
	children,
	...props
}: Readonly<TestSuiteContentProps>) {
	return (
...
function TestStatusIcon({ status }: Readonly<{ status: TestStatus }>) {
	return (
...
export function TestName({ className, children, ...props }: Readonly<TestNameProps>) {
...
export function TestError({
	...
	children,
	...props
}: Readonly<TestErrorProps>) {
	return (
		<div
			className={cn(
				"mt-2 rounded-md bg-red-50 p-3",
				className
			)}
			{...props}
		>
...
export function TestErrorMessage({
	...
	children,
	...props
}: Readonly<TestErrorMessageProps>) {
	return (
		<p
			className={cn(
...
export function TestErrorStack({
	...
	children,
	...props
}: Readonly<TestErrorStackProps>) {
	return (
		<pre
			className={cn(
				"mt-2 overflow-auto font-mono text-red-600 text-xs",
				className
			)}
			{...props}
		>
