...
import {
  ...
  type AudioFormat,
  type CommitStrategy,
} from "@/components/ui-audio/hooks/use-scribe"
...
const SpeechInput = forwardRef<HTMLDivElement, SpeechInputProps>(
  ...
  useEffect(() => {
    ...
    return (
      <SpeechInputContext value={contextValue}>
        <div
          ref={ref}
          className={cn(
...
>(function SpeechInputRecordButton(
  ...
  return (
    ...
    >
      <div
        className={cn(
          "bg-bg-selected-bold absolute h-4 w-4 rounded-full transition-all duration-200",
      ...
      <SquareIcon
        className={cn(
          "text-icon-danger absolute h-4 w-4 fill-current transition-all duration-200",
      ...
      <div
        ...
        className={cn(
          ...
          showPlaceholder
            ...
            : "text-text [mask-image:linear-gradient(to_right,transparent,black_16px,black_calc(100%-16px),transparent)]",
