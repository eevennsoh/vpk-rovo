...
export const AudioScrubber = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-bg-selected-bold/20 pointer-events-none absolute inset-y-0 left-0"
        style={{ width: `${localProgress * 100}%` }}
      />

      <div
        className="bg-bg-selected-bold pointer-events-none absolute top-0 bottom-0 w-0.5"
