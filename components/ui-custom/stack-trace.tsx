...
export const StackTraceError = memo(
	function StackTraceError({ className, children, ...props }: Readonly<StackTraceErrorProps>) {
		return (
			<div
				className={cn(
...
export const StackTraceErrorType = memo(
	function StackTraceErrorType({ className, children, ...props }: Readonly<StackTraceErrorTypeProps>) {
...
export const StackTraceErrorMessage = memo(
	function StackTraceErrorMessage({ className, children, ...props }: Readonly<StackTraceErrorMessageProps>) {
		const { trace } = useStackTrace();
...
export const StackTraceActions = memo(
	function StackTraceActions({ className, children, ...props }: Readonly<StackTraceActionsProps>) {
		return (
...
export const StackTraceCopyButton = memo(
	function StackTraceCopyButton({
		...
		children,
		...props
	}: Readonly<StackTraceCopyButtonProps>) {
...
export const StackTraceExpandButton = memo(
	function StackTraceExpandButton({ className, ...props }: Readonly<StackTraceExpandButtonProps>) {
...
const FilePathButton = memo(
	function FilePathButton({ frame, onFilePathClick }: Readonly<FilePathButtonProps>) {
...
export const StackTraceFrames = memo(
	function StackTraceFrames({
		...
		...props
	}: Readonly<StackTraceFramesProps>) {
