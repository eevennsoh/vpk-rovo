...
export const AlertCircle = createUnsafeVpkIcon(WarningIconGlyph);
...
export const Code = createUnsafeVpkIcon(CommentIconGlyph);
...
export const MicOff = createUnsafeVpkIcon(MicrophoneStrikethroughIconGlyph);
...
export const Activity = AudioWaveformIcon;
...
export const Inbox = createUnsafeVpkIcon(InboxIconGlyph);
...
export const LineChart = ChartLineIcon;
...
export const Footprints = ListTodoIcon;
export const Waves = AudioWaveformIcon;
...
export const GalleryVerticalEnd = createUnsafeVpkIcon(ViewTypeCardHomeIconGlyph);
export const ShareIcon = createUnsafeVpkIcon(ShareIconGlyph);
export const Share = ShareIcon;
export const Forward = ShareIcon;
export const Send = createUnsafeVpkIcon(SendIconGlyph);
...
export const MoreHorizontal = EllipsisVerticalIcon;
...
export const MousePointerClick = MousePointerIcon;
...
export const VolumeX = createUnsafeVpkIcon(VolumeMutedIconGlyph);
...
export const Settings2 = SettingsIcon;
export const Blocks = Columns3Icon;
export const MessageCircleQuestion = HelpCircleIcon;
export const TreePine = createUnsafeVpkIcon(TreeIconGlyph);
export const Frame = MonitorIcon;
export const Map = GlobeIcon;
export const PieChart = ChartPieIcon;
export const SquareTerminal = TerminalIcon;
export const BadgeCheck = CheckCircleIcon;
