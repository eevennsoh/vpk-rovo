...
export function DocHero({ name, description, category, importPath, adsLinks, adsUrl, adsPackage }: Readonly<DocHeroProps>) {
	const categoryLabel = category === "ui-audio" ? "UI — Audio" : category === "ui-custom" ? "UI — Custom" : category === "blocks" ? "Blocks" : category === "projects" ? "Projects" : category === "visual" ? "Visual" : category === "utility" ? "Utils" : category === "arts" ? "Arts" : "UI";
