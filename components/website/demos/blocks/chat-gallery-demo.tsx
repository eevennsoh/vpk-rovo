...
import ChatGallery from "@/components/blocks/chat-gallery/page";
...
export default function ChatGalleryDemo() {
		...
		<div className="flex h-full w-full flex-col items-center">
			...
			<div className="flex w-full max-w-[800px] flex-col items-center shrink-0 px-4" style={{ gap: token("space.100") }}>
				...
				<div className="w-full" style={{ marginTop: token("space.300") }}>
					<ChatGallery onSelect={(selectedPrompt) => setPrompt(selectedPrompt)} onPreviewStart={setPreviewPrompt} onPreviewEnd={() => setPreviewPrompt(null)} onExpandChange={setGalleryExpanded} />
				</div>
			</div>
