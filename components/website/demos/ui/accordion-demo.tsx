	...
	return (
		<Accordion className="w-56">
			<AccordionItem value="item-1">
				<AccordionTrigger>What is VPK?</AccordionTrigger>
				<AccordionContent>A prototype kit for Atlassian products.</AccordionContent>
			</AccordionItem>
			<AccordionItem value="item-2">
				<AccordionTrigger>How do I start?</AccordionTrigger>
				<AccordionContent>Run pnpm install and pnpm dev.</AccordionContent>
			</AccordionItem>
		</Accordion>
	);
}

export function AccordionDemoBasic() {
	const items = [
		{
			value: "item-1",
...
export function AccordionDemoDefault() {
	return (
...
export function AccordionDemoInCard() {
	const items = [
		{
			value: "plans",
...
export function AccordionDemoMultiple() {
	const items = [
		{
			value: "item-1",
			trigger:
...
export function AccordionDemoOpen() {
	return (
...
export function AccordionDemoWithBorders() {
	const items = [
		{
			value: "billing",
			trigger: "How does billing work?",
...
export function AccordionDemoWithDisabled() {
	const items = [
		{
			value: "item-1",
