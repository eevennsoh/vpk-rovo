	...
	return (
		<ItemGroup className="w-48">
			<Item>
				...
				<ItemDescription>A list item</ItemDescription>
			</Item>
			<Item>
				<ItemTitle>Item two</ItemTitle>
				<ItemDescription>Another item</ItemDescription>
			</Item>
		</ItemGroup>
	);
}
...
export function ItemDemoDefaultItemMediaImage() {
	return (
		<>
			<Item>
...
export function ItemDemoDefault() {
	return (
		<>
			<Item>
				<ItemContent>
...
export function ItemDemoExtraSmall() {
	return (
		<>
			<Item size="xs">
				<ItemContent>
...
export function ItemDemoItemFooter() {
	return (
		<>
			<Item>
				<ItemContent>
...
export function ItemDemoItemGroup() {
	return (
		<ItemGroup>
			<Item>
				<ItemContent>
...
export function ItemDemoItemHeaderItemFooter() {
	return (
		<>
			<Item>
				<ItemHeader>
...
export function ItemDemoItemHeader() {
	return (
		<>
			<Item>
				<ItemHeader>
...
export function ItemDemoItemSeparator() {
	return (
		<ItemGroup>
			<Item variant="outline">
				<ItemMedia variant="icon">
...
export function ItemDemoMutedExtraSmall() {
	return (
		<>
...
export function ItemDemoMutedItemGroup() {
	return (
		<ItemGroup>
			<Item variant="muted">
				<ItemContent>
...
export function ItemDemoMutedItemMediaImage() {
	return (
		<>
			<Item variant="muted">
				<ItemMedia variant="image">
...
export function ItemDemoMutedSmall() {
	return (
		<>
...
export function ItemDemoOutlineExtraSmall() {
	return (
		<>
...
export function ItemDemoOutlineItemGroup() {
	return (
		<ItemGroup>
			<Item variant="outline">
				<ItemMedia variant="icon">
...
export function ItemDemoOutlineItemMediaImageExtraSmall() {
	return (
		<>
			<Item variant="outline" size="xs">
				<ItemMedia variant="image">
...
export function ItemDemoOutlineItemMediaImageSmall() {
	return (
		<>
...
export function ItemDemoOutlineItemMediaImage() {
	return (
		<>
			<Item variant="outline">
				<ItemMedia variant="image">
...
export function ItemDemoOutlineSmall() {
	return (
		<>
			<Item variant="outline" size="sm">
				<ItemContent>
...
export function ItemDemoOutline() {
	return (
		<>
			<Item variant="outline">
				<ItemContent>
...
export function ItemDemoWithDescription() {
	return (
		<Item>
			<ItemContent>
				<ItemTitle>Item with description</ItemTitle>
				<ItemDescription>
					This is a secondary description that provides additional context about the item.
				</ItemDescription>
			</ItemContent>
		</Item>
	);
...
export function ItemDemoWithMedia() {
	return (
		<Item>
			<ItemMedia variant="icon">
			...
			<ItemContent>
				...
				<ItemDescription>
					This item includes an icon in the media slot.
				</ItemDescription>
			</ItemContent>
		</Item>
	);
