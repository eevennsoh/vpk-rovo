...
export default function LiquidGradient({
	...
	}, [colors, colorsKey, seed, speed, loop, scale, turbAmp, turbFreq, turbIter, waveFreq, distBias, jellify, ditherMode, dither, exposure, contrast, saturation, shouldAnimate]);
