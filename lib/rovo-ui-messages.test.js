...
test("getLatestPendingToolApproval returns the newest unresolved tool approval batch", () => {
	const approval = getLatestPendingToolApproval([
		{
			id: "assistant-1",
			role: "assistant",
			parts: [
...
test("getLatestPendingToolApproval clears after hidden tool-approval submit", () => {
	const approval = getLatestPendingToolApproval([
		{
			id: "assistant-1",
			role: "assistant",
