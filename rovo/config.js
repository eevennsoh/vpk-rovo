...
const REQUEST_USER_INPUT_INSTRUCTION = [
	...
	"The tool renders an interactive question card in the UI. Provide 2–4 questions only when needed, each with a short label, optional description, and 1–4 predefined options. The UI automatically appends one free-text option.",
...
const AI_GATEWAY_DEFERRED_TOOLS_INSTRUCTION = [
	...
	"```",
	"",
	"Question fields are `question`, `header`, and `options`. Provide 2–4 questions only when needed, with 1–4 concrete preset options per question.",
