...
export const TEST_FILE_CLASSIFICATIONS = {
	stable: [
		...
		"components/blocks/jira-create/jira-create-motion.test.js",
		"components/blocks/jira-create/lib/jira-create-insert.test.js",
		"components/blocks/jira-create/lib/jira-create-column-scroll.test.js",
