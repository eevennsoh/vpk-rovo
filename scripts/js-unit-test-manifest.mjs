...
export const TEST_FILE_CLASSIFICATIONS = {
	...
	"source-contract": [
		...
		"components/blocks/agent-assignment/agent-assignment-field-status.test.js",
		...
		"components/blocks/agent-session/agent-session-link-work-item.test.js",
		...
		"components/blocks/jira-issue/jira-issue-assignee.test.js",
		...
		"components/blocks/jira-kanban/jira-kanban-contract.test.js",
