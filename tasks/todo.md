# Rename VPK-rovo to VPK

- [x] Permanently delete the existing private `eevennsoh/vpk` repository.
- [x] Migrate tracked runtime and source identities to `vpk`.
- [x] Add compatibility handling for protocol consumers and remove obsolete persisted-state residue.
